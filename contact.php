...
if(isset($_POST['sub'])){
    ...
    $sql="INSERT INTO `contactus`(`name`, `email`, `select_topic`, `message`) VALUES ('$name','$email','$select_topic','$message')";
...
<!-- Mirrored from html.themexriver.com/Attorney/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 18:37:46 GMT -->
...
<head>
	...
	<title>Attorney Law HTML Template | Contact</title>
	<!-- Stylesheets -->
...
?>
	...
	<form method="post" action="https://html.themexriver.com/Attorney/blog.html">
						...
						<div class="info-column col-lg-7 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								<ul class="list-style-six">
									...
									<li><span class="icon fa fa-envelope-o"></span>support@Attorney.com</li>
								</ul>
							</div>
						</div>
							...
							<div class="inner-column">
								...
								<div class="contact-form">
									<form method="post" action="" id="contact-form">
										...
										<div class="form-group" >
											<select class="custom-select-box" name="select_topic">
			...
			<div class="row clearfix">
				...
				<div class="column col-lg-4 col-md-6 col-sm-12">
					...
					<ul class="list-style-seven">
						...
						<li><span class="icon fa fa-envelope-o"></span>support@Attorney.com.uk</li>
					</ul>
				</div>
				<div class="column col-lg-4 col-md-6 col-sm-12">
					<h4>Australia</h4>
...
<!-- Mirrored from html.themexriver.com/Attorney/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 18:37:47 GMT -->
</html>